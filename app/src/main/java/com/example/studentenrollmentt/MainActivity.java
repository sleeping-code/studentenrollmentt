package com.example.studentenrollmentt;
...
import com.example.studentenrollmentt.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setBackgroundColor(yellowColor);
        loginButton.setBackgroundColor(yellowColor);
        enrollButton.setBackgroundColor(yellowColor);
        summaryButton.setBackgroundColor(yellowColor);
